...
svm_model = joblib.load(r'D:\GitHub\Machine_Learning\weithts\svm_model.pkl')
...
while True:
    ...
    for face in faces:
        ...
        svm_label_idx = svm_model.predict(hog_features)[0]
        svm_label = labels[svm_label_idx]

        # Vẽ khung và nhãn lên khuôn mặt
        cv2.rectangle(frame, (x, y), (x + w, y + h), (0, 255, 0), 2)
        cv2.putText(frame, f'SVM: {svm_label}', (x, y), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 0, 0), 2)
