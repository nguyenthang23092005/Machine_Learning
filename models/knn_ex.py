...
# Tìm các tham số tối ưu cho mô hình KNN sử dụng GridSearchCV
param_grid = {
...
# Lưu mô hình KNN tối ưu vào file sử dụng joblib
knn_model_path = os.path.join(weights_dir, 'knn_model_ex_optimal.joblib')
